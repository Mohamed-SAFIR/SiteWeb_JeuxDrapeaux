...
<body id=bdj>
    ...
    <div>
        <div class="d-flex justify-content-between mb-3" style="margin:100px 100px">
            <div class="p-2 "><span id="compteur" class="rounded-circle btn-primary btn-lg">0/46</span></div>
            <div class="p-2"><a style="broder-raduis: 20px;" href="monde.php" class="btn btn-primary btn-lg" >Rejoueur</a></div>
            <div class="p-2">
        ...
        function onMapClick(e){
		    ...
		    success: function(data){
				...
				if (data.address.country == my[0].features[index].proprietes.pays.name){
					...
					nbrQuestionCorrect++;
                	$("#compteur").html(nbrQuestionCorrect+'/46');
					var res = $("#score").text();
					var num = Number(res);
					$("#score").html(num + 1000);	
