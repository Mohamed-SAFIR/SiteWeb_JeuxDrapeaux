...
<head>
    <meta charset="UTF-8">
    <title>Jouer sans inscription</title>
...
<body id=bdj>
    ...
    <div>
        <div class="d-flex justify-content-between mb-3" style="margin:100px 100px">
            ...
            <div class="p-2"><a style="broder-raduis: 20px;" href="jouer.php" class="btn btn-primary btn-lg" >Rejoueur</a></div>
            <div class="p-2"><a style="broder-raduis: 20px;" href="index.php" class="btn btn-primary btn-lg" >Quitter</a></div>
            <div class="p-2">
